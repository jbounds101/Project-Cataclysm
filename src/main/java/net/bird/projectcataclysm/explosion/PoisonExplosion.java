...
public class PoisonExplosion {
    ...
    public PoisonExplosion(World world, @Nullable Entity entity, @Nullable ExplosionBehavior behavior, double x, double y, double z, float power) {
        this.world = world;
        this.entity = entity;
        this.power = power;
        this.x = x;
    ...
    public void affectWorld() {
        ...
        */
        ...
        for (int v = 0; v < affectedEntities.size(); ++v) {
            ...
            y /= aa;
            z /= aa;
            double ab = PoisonExplosion.getExposure(vec3d, entity);
            double ac = (1.0 - w) * ab;
            ...
            if (entity instanceof LivingEntity) {
                ...
                ((LivingEntity) entity).addStatusEffect(new StatusEffectInstance(StatusEffects.POISON, 100, 1,
                        false, true, true));
                entity.sendMessage(Text.literal("You have been poisoned!"));
            }
            /*
