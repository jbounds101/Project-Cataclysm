...
public class SuctionExplosion {
    ...
    public SuctionExplosion(World world, @Nullable Entity entity, @Nullable ExplosionBehavior behavior, double x, double y, double z, float power) {
        this.world = world;
        this.entity = entity;
        this.power = power;
        this.x = x;
    ...
    public void affectWorld() {
        ...
        */
        ...
        for (int v = 0; v < affectedEntities.size(); ++v) {
            ...
            y /= aa;
            z /= aa;
            double ab = SuctionExplosion.getExposure(vec3d, entity);
            double ac = (1.0 - w) * ab;
