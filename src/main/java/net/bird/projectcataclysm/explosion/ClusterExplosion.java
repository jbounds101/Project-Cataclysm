...
public class ClusterExplosion {
    ...
    public ClusterExplosion(World world, @Nullable Entity entity, @Nullable ExplosionBehavior behavior, double x, double y, double z, float power) {
        this.world = world;
        this.entity = entity;
        this.power = power;
        this.x = x;
    ...
    public void affectWorld() {
        ...
        /*for (BlockPos blockPos : this.affectedBlocks) {
            ...
            tntEntity.refreshPositionAfterTeleport(blockPos.getX(), blockPos.getY(), blockPos.getZ());
            tntEntity.setFuse(random.nextBetween(1, 4));
