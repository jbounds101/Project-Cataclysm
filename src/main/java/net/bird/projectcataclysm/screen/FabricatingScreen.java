...
public class FabricatingScreen extends HandledScreen<FabricatingScreenHandler> implements RecipeBookProvider {
    private static final Identifier TEXTURE = new Identifier(ProjectCataclysmMod.MOD_ID,"textures/gui/fabricator.png");
    private static final Identifier RECIPE_BUTTON_TEXTURE = new Identifier(ProjectCataclysmMod.MOD_ID,"textures/gui/recipe_button.png");
    private final RecipeBookWidget recipeBook = new RecipeBookWidget();
    private boolean narrow;

    public FabricatingScreen(FabricatingScreenHandler handler, PlayerInventory inventory, Text title) {
        super(handler, inventory, title);
        this.backgroundHeight = 202;
        this.backgroundWidth = 188;
        this.titleX = 8;
        this.titleY = 6;
        this.playerInventoryTitleX = 14;
